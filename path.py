...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        self.title('---- Navigation_robotique PFE ----')
    ...
    def build_environment(self):
        ...
        # Obstacle ligne 1
        # Defining the center of obstacle 
        ...
        obstacle2_center = self.o + np.array([pixels*0, pixels * 3])
        ...
        obstacle3_center = self.o + np.array([pixels * 0, pixels * 4])
        # Building the obstacle 2
        ...
        obstacle4_center = self.o + np.array([pixels * 0, pixels * 5])
        ...
        obstacle5_center = self.o + np.array([pixels * 0, pixels * 6])
        ...
        obstacle6_center = self.o + np.array([pixels * 0, pixels * 7])
        ...
        obstacle8_center = self.o + np.array([pixels * 0, pixels * 9])
        ...
        obstacle9_center = self.o + np.array([pixels * 0, pixels * 10])
        # Building the obstacle 4
        ...
        obstacle10_center = self.o + np.array([pixels * 0, pixels * 11])
        ...
        obstacle11_center = self.o + np.array([pixels * 0, pixels * 12])
        ...
        # Obstacle 12
        # Defining the center of obstacle 5
        obstacle12_center = self.o + np.array([pixels * 0, pixels * 13])
        ...
        obstacle13_center = self.o + np.array([pixels * 0, pixels * 14])
        ...
        obstacle14_center = self.o + np.array([pixels * 0, pixels * 15])
        ...
        obstacle15_center = self.o + np.array([pixels * 0, pixels * 16])
        # Building the obstacle 8
        ...
        obstacle16_center = self.o + np.array([pixels * 0, pixels * 17])
        ...
        obstacle17_center = self.o + np.array([pixels * 0, pixels * 18])
        # Building the obstacle 10
        ...
        obstacle22_center = self.o + np.array([pixels * 0, pixels * 19])
        ...
        obstacle23_center = self.o + np.array([pixels * 0, pixels * 20])
        ...
        obstacle24_center = self.o + np.array([pixels * 0, pixels * 21])
        ...
        obstacle20_center = self.o + np.array([pixels * 0, pixels * 22])
        ...
        obstacle21_center = self.o + np.array([pixels * 0, pixels * 23])
        ...
        # Obstacle 19
        # Defining the center of obstacle 19
        obstacle19_center = self.o + np.array([pixels * 0, pixels * 24])
        # Building the obstacle 19
        ...
        obstacle18_center = self.o + np.array([pixels * 1, pixels * 24])
        ...
        obstacle25_center = self.o + np.array([pixels * 2, pixels * 24])
        ...
        obstacle26_center = self.o + np.array([pixels * 3, pixels * 24])
        ...
        obstacle39_center = self.o + np.array([pixels * 4, pixels * 24])
        ...
        obstacle38_center = self.o + np.array([pixels * 5, pixels * 24])
        ...
        obstacle37_center = self.o + np.array([pixels * 6, pixels * 24])
        ...
        obstacle36_center = self.o + np.array([pixels * 7, pixels * 24])
        ...
        obstacle35_center = self.o + np.array([pixels * 8, pixels * 24])
        ...
        obstacle34_center = self.o + np.array([pixels * 9, pixels * 24])
        ...
        obstacle33_center = self.o + np.array([pixels * 10, pixels * 24])
        ...
        obstacle32_center = self.o + np.array([pixels * 11, pixels * 24])
        ...
        obstacle31_center = self.o + np.array([pixels * 12, pixels * 24])
        ...
        obstacle30_center = self.o + np.array([pixels * 13, pixels * 24])
        # Building the obstacle 31
        ...
        obstacle29_center = self.o + np.array([pixels * 14, pixels * 24])
        ...
        obstacle28_center = self.o + np.array([pixels * 15, pixels * 24])
        ...
        obstacle27_center = self.o + np.array([pixels * 16, pixels * 24])
        ...
        obstacle46_center = self.o + np.array([pixels * 17, pixels * 24])
        ...
        obstacle47_center = self.o + np.array([pixels * 18, pixels * 24])
        ...
        # Obstacle 48
        # Defining the center of obstacle 34
        obstacle48_center = self.o + np.array([pixels * 19, pixels * 24])
        # Building the obstacle 34
        ...
        obstacle49_center = self.o + np.array([pixels * 20, pixels * 24])
        ...
        obstacle50_center = self.o + np.array([pixels * 21, pixels * 24])
        ...
        obstacle45_center = self.o + np.array([pixels * 22, pixels * 24])
        ...
        obstacle40_center = self.o + np.array([pixels * 23, pixels * 24])
        ...
        obstacle41_center = self.o + np.array([pixels * 24, pixels * 24])
        ...
        obstacle42_center = self.o + np.array([pixels * 24, pixels * 23])
        ...
        obstacle43_center = self.o + np.array([pixels * 24, pixels * 22])
        ...
        obstacle44_center = self.o + np.array([pixels * 24, pixels * 21])
        ...
        obstacle54_center = self.o + np.array([pixels * 24, pixels * 20])
        # Building the obstacle 44
        ...
        obstacle55_center = self.o + np.array([pixels * 24, pixels * 19])
        ...
        # Obstacle 56
        # Defining the center of obstacle 46
        obstacle56_center = self.o + np.array([pixels * 24, pixels * 18])
        ...
        obstacle53_center = self.o + np.array([pixels * 24, pixels * 17])
        ...
        obstacle52_center = self.o + np.array([pixels * 24, pixels * 16])
        ...
        obstacle51_center = self.o + np.array([pixels * 24, pixels * 15])
        ...
        obstacle100_center = self.o + np.array([pixels * 24, pixels * 14])
        ...
        obstacle101_center = self.o + np.array([pixels * 24, pixels * 13])
        ...
        obstacle102_center = self.o + np.array([pixels * 24, pixels * 12])
        ...
        obstacle103_center = self.o + np.array([pixels * 24, pixels * 11])
        ...
        obstacle104_center = self.o + np.array([pixels * 24, pixels * 10])
        ...
        obstacle105_center = self.o + np.array([pixels * 24, pixels * 9])
        ...
        obstacle106_center = self.o + np.array([pixels * 24, pixels * 8])
        ...
        obstacle107_center = self.o + np.array([pixels * 24, pixels * 7])
        ...
        obstacle108_center = self.o + np.array([pixels * 24, pixels * 6])
        ...
        obstacle109_center = self.o + np.array([pixels * 24, pixels * 5])
        ...
        obstacle110_center = self.o + np.array([pixels * 24, pixels * 4])
        ...
        obstacle111_center = self.o + np.array([pixels * 24, pixels * 3])
        ...
        obstacle112_center = self.o + np.array([pixels * 24, pixels * 2])
        ...
        obstacle113_center = self.o + np.array([pixels * 24, pixels * 1])
        ...
        obstacle114_center = self.o + np.array([pixels * 24, pixels * 0])
        ...
        obstacle115_center = self.o + np.array([pixels * 23, pixels * 0])
        ...
        obstacle116_center = self.o + np.array([pixels * 22, pixels * 0])
        ...
        obstacle117_center = self.o + np.array([pixels * 21, pixels * 0])
        ...
        obstacle118_center = self.o + np.array([pixels * 20, pixels * 0])
        ...
        obstacle119_center = self.o + np.array([pixels * 19, pixels * 0])
        ...
        obstacle120_center = self.o + np.array([pixels * 18, pixels * 0])
        ...
        obstacle121_center = self.o + np.array([pixels * 17, pixels * 0])
        ...
        obstacle122_center = self.o + np.array([pixels * 16, pixels * 0])
        ...
        obstacle123_center = self.o + np.array([pixels * 15, pixels * 0])
        # Building the obstacle 122
        ...
        obstacle124_center = self.o + np.array([pixels * 14, pixels * 0])
        ...
        obstacle125_center = self.o + np.array([pixels * 13, pixels * 0])
        ...
        obstacle126_center = self.o + np.array([pixels * 12, pixels * 0])
        ...
        obstacle127_center = self.o + np.array([pixels * 11, pixels * 0])
        ...
        obstacle128_center = self.o + np.array([pixels * 10, pixels * 0])
        ...
        obstacle129_center = self.o + np.array([pixels * 9, pixels * 0])
        ...
        obstacle130_center = self.o + np.array([pixels * 9, pixels * 1])
        ...
        obstacle131_center = self.o + np.array([pixels * 9, pixels * 2])
        ...
        obstacle132_center = self.o + np.array([pixels * 9, pixels * 3])
        ...
        obstacle133_center = self.o + np.array([pixels * 9, pixels * 4])
        ...
        obstacle134_center = self.o + np.array([pixels * 1, pixels * 14])
        ...
        obstacle135_center = self.o + np.array([pixels * 2, pixels * 14])
        ...
        obstacle136_center = self.o + np.array([pixels * 3, pixels * 14])
        ...
        obstacle137_center = self.o + np.array([pixels * 4, pixels * 14])
        ...
        obstacle138_center = self.o + np.array([pixels * 5, pixels * 14])
        ...
        obstacle139_center = self.o + np.array([pixels * 6, pixels * 14])
        ...
        obstacle140_center = self.o + np.array([pixels * 23, pixels * 10])
        ...
        obstacle141_center = self.o + np.array([pixels * 22, pixels * 10])
        ...
        obstacle142_center = self.o + np.array([pixels * 21, pixels * 10])
        ...
        obstacle143_center = self.o + np.array([pixels * 20, pixels * 10])
        ...
        obstacle144_center = self.o + np.array([pixels * 19, pixels * 10])
        ...
        obstacle145_center = self.o + np.array([pixels * 18, pixels * 10])
        ...
        obstacle146_center = self.o + np.array([pixels * 17, pixels * 10])
        ...
        obstacle147_center = self.o + np.array([pixels * 16, pixels * 10])
        ...
        obstacle148_center = self.o + np.array([pixels * 15, pixels * 10])
        ...
        obstacle149_center = self.o + np.array([pixels * 14, pixels * 10])
        ...
        obstacle150_center = self.o + np.array([pixels * 14, pixels * 11])
        ...
        obstacle151_center = self.o + np.array([pixels * 11, pixels * 23])
        ...
        obstacle152_center = self.o + np.array([pixels * 11, pixels * 22])
        ...
        obstacle153_center = self.o + np.array([pixels * 11, pixels * 21])
        ...
        obstacle154_center = self.o + np.array([pixels * 11, pixels * 20])
        ...
        img_background1 = Image.open("images/robot.png")
        self.background1 = ImageTk.PhotoImage(img_background1)
        self.agent = self.canvas_widget.create_image(0, 0, anchor='nw', image=self.background1)
